...
namespace TestNinja.UnitTests.Mocking
{
    ...
    public class BookingHelperTests
    {
        ...
        [Test]
        public void BookingStartsAndFinishesBeforeAnExistingBooking_ReturnExistingBookingsReference()
        {
        ...
        [Test]
        public void BookingStartsBeforAndFinishesInTheMiddleAnExistingBooking_ReturnEmptyString()
        {
            var result = BookingHelper.OverlappingBookingsExist(new Booking
            {
                Id = 1,
        ...
        [Test]
        public void BookingStartsBeforAndFinishesAfterAnExistingBooking_ReturnEmptyString()
        {
            var result = BookingHelper.OverlappingBookingsExist(new Booking
            {
                Id = 1,
